...
namespace ET.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    public abstract class ETRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<ETDbContext, TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        private readonly IActiveTransactionProvider _transactionProvider;
        protected ETRepositoryBase(IDbContextProvider<ETDbContext> dbContextProvider, IActiveTransactionProvider transactionProvider)
        ...
        private DbTransaction GetActiveTransaction()
        {
            ...
            {
                {"ContextType", typeof(ETDbContext) },
    ...
    /// <summary>
    /// Base class for custom repositories of the application.
    /// This is a shortcut of <see cref="ETRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class ETRepositoryBase<TEntity> : ETRepositoryBase<TEntity, int>, IRepository<TEntity>
