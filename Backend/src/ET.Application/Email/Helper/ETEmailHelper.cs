...
namespace ET.Email.Helper
{
    public class ETEmailHelper : IETEmailHelper
    {
        ...
        {
            if (_settingManager.GetSettingValue(ETConsts.ETEmailSettings.EnableSmtp) == "false")
                return false;
            ...
            mail.Subject = ReplaceContent(_settingManager.GetSettingValue($"{emailTemplateType}.{ETConsts.ETEmailSettings.AllocatedResourceTitle}"), modelInput);

            mail.SubjectEncoding = Encoding.UTF8;

            mail.Body = ReplaceContent(_settingManager.GetSettingValue($"{emailTemplateType}.{ETConsts.ETEmailSettings.AllocatedResourceBody}"), modelInput);
